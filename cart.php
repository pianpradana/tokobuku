...
if(isset($_GET["action"])){
	...
	if($_GET["action"] == "delete"){
		...
		foreach($_SESSION["shopping_cart"] as $keys => $values){
			...
			$hasil=mysqli_query($conn,"INSERT INTO tb_transaksi SET id_transaksi=$id_transaksi, id_user='$id_user', id_produk='$id_produk'");
		}
	...
	<div class="table-responsive text-center">
        ...
        <?php 
        	if(!empty($_SESSION["shopping_cart"])){ ?>
				...
				<a style="width: auto; margin: 3% 0 0;" class="btn btn-success" href="#" onclick="buyAll()">Bayar Sekarang</a>
        		<?php
        	}
        	else{
