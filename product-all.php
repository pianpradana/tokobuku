<div class="row text-center">
	...
	<form method="post" action="product.php?action=add&id_produk=<?php echo $c["id_produk"]; ?>">
		<div class="card" id="<?php echo $id_produk;?>">
			<img class="card-img-top" style="height: 350px;" src="images/buku/<?php echo $image_buku;?>" alt="<?php echo $image_buku ?>" />
			<div class="card-body">
			...
			<div class="card-footer">
	            ...
	            if(isset($_SESSION['id'])){
	                ...
	                echo "<a href=\"\" onClick=\"onCartClick()\" class=\"btn btn-success\">Beli</a>";
	            }
	            ?>
			</div>
		</div>
